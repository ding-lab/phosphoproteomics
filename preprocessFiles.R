...
brca_s_f = read.table(sep="\t", file='/Users/khuang/Box Sync/PhD/proteogenomics/CPTAC_pan3Cancer/sample_list/final_list/TCGA_Breast_BI_Proteome_CDAP_sample_77unimodal_u.list')
brca_s = as.vector(t(brca_s_f))
brca_s2 = gsub("-",".",as.vector(t(brca_s_f)))
ov_s_f = read.table(sep="\t", file='/Users/khuang/Box Sync/PhD/proteogenomics/CPTAC_pan3Cancer/sample_list/final_list/TCGA_Ovarian_Combined_Proteome_CDAP_sample.list')
ov_s = as.vector(t(ov_s_f))
crc_s_f = read.table(sep="\t", file='/Users/khuang/Box Sync/PhD/proteogenomics/CPTAC_pan3Cancer/sample_list/final_list/TCGA_Colon_VU_Proteome_CDAP_sample_u.list')
...
### Mutation matrix ###
BRCA_mut = read.table(row.names=1, header=TRUE, sep="\t", file="/Users/khuang/Box\ Sync/PhD/proteogenomics/CPTAC_pan3Cancer/data/201510_pancan_somatic/BRCA_proteomic.maf.matrix.txt")
...
### Mutation matrix ###
OV_mut = read.table(row.names=1, header=TRUE, sep="\t", check.names=F, file="/Users/khuang/Box\ Sync/PhD/proteogenomics/CPTAC_pan3Cancer/data/201510_pancan_somatic/OV_proteomic.maf.matrix.txt")
...
##### CRC #####
### Mutation matrix ###
CRC_mut = read.table(row.names=1, header=TRUE, sep="\t", file="/Users/khuang/Box\ Sync/PhD/proteogenomics/CPTAC_pan3Cancer/data/201510_pancan_somatic/COADREAD_proteomic.maf.matrix.txt")
