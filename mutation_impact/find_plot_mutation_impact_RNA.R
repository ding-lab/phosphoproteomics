...
BRCA_RNA_c = BRCA_RNA[row.names(BRCA_RNA) %in% druggable,]
...
OV_RNA_c = OV_RNA[row.names(OV_RNA) %in% druggable,]
...
fn = paste(pd, 'merged_diff_exp_cgenes_druggable_RNA_fdr0.1in1.pdf',sep ="_")
