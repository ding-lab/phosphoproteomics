...
BRCA_CNV.d = BRCA_CNV[row.names(BRCA_CNV) %in% druggable,]
...
BRCA_Pro.d = BRCA_Pro[row.names(BRCA_Pro) %in% druggable,]
...
BRCA_Pho.d = BRCA_Pho[row.names(BRCA_Pho) %in% druggable,]
...
gene = sub(" .*","",gene)
BRCA_RPPA.d = BRCA_RPPA[gene %in% druggable,]
...
OV_CNV.d = OV_CNV[row.names(OV_CNV) %in% druggable,]
...
OV_RNA.d = OV_RNA[row.names(OV_RNA) %in% druggable,]
...
OV_JHU_Pro.d = OV_JHU_Pro[row.names(OV_JHU_Pro) %in% druggable,]
OV_PNNL_Pro.d = OV_PNNL_Pro[row.names(OV_PNNL_Pro) %in% druggable,]
...
OV_Pho.d = OV_Pho[row.names(OV_Pho) %in% druggable,]
...
OV_Gly.d = OV_Gly[row.names(OV_Gly) %in% druggable,]
...
gene = sub(" .*","",gene)
OV_RPPA.d = OV_RPPA[gene %in% druggable,]
...
CRC_CNV.d = CRC_CNV[row.names(CRC_CNV) %in% druggable,]
...
CRC_RNA.d = CRC_RNA[row.names(CRC_RNA) %in% druggable,]
...
CRC_Pro.d = CRC_Pro[row.names(CRC_Pro) %in% druggable,]
...
gene = sub(" .*","",gene)
CRC_RPPA.d = CRC_RPPA[gene %in% druggable,]
