...
for (g in 588:length(unique_substrate)) {
...
## write out tables
tn = paste(baseD,"pan3can_shared_data/analysis_results/hotspot3d/table/",cancer,"_phosphosite_correlation.txt", sep="")
...
p
fn = paste(baseD,'pan3can_shared_data/analysis_results/volcano_plots/',cancer,"_",protein,'_substrate_phosphosite_correlation_volcano.pdf',sep ="")
ggsave(file=fn, height=6, width=8, useDingbats=FALSE)
dev.off()


# input pairwise hotspot3d result -----------------------------------------
pairwise <- read.delim(paste(baseD,"pan3can_shared_data/analysis_results/hotspot3d/cptac.brca.phosphosites.pairwise.singleprotein.collapsed_for_R.txt",sep = ""))
...
tn = paste(baseD,"pan3can_shared_data/analysis_results/hotspot3d/table/",cohort,"_phosphosite_distance_and_phospho_corr.txt", sep="")
...
fn = paste(baseD,'pan3can_shared_data/analysis_results/hotspot3d/distance_3d_and_coef_corr_correlation.png',sep ="")
...
# test whether any of these substrate rsd pairs have common kinase --------
