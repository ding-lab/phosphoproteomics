...
p
fn = paste(baseD,'pan3can_shared_data/analysis_results/volcano_plots/Cis_',protein,'_substrate_volcano_trans_edited.pdf',sep ="")
...
p
fn = paste(baseD,'pan3can_shared_data/analysis_results/volcano_plots/Trans_',protein,'_substrate_volcano_trans_edited.pdf',sep ="")
ggsave(file=fn, height=3, width=6, useDingbats=FALSE)
