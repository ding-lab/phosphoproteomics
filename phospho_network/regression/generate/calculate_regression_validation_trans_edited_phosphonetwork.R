...
table_2can = table_2can[!(table_2can$pair %in% table_2can_prev$pair),]
...
tn = paste(baseD,"pan3can_shared_data/analysis_results/regression/table/",cancer,'_',protein,"_trans_regression_validation_statistics_phosphonetwork.txt", sep="")
...
tn = paste(baseD,"pan3can_shared_data/analysis_results/regression/table/",cancer,'_',protein,"_trans_regression_validation_statistics_for_residual_phosphonetwork.txt", sep="")
