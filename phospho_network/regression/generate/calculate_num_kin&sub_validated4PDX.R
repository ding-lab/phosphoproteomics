...
table_2can <- read.delim(paste(baseD,"pan3can_shared_data/analysis_results/tables/",protein,"_PDX_substrate_regression_trans_edited.txt",sep = ""))
...
time <- Sys.time()
sink(file = paste(baseD,"pan3can_shared_data/analysis_results/tables/No.PDX_validated_kinases_substrates_fdr_",sig,"_",time,".txt",sep = ""))
