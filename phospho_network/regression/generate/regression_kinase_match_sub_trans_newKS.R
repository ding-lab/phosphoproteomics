...
if ( protein == "kinase" ) {
  ...
  k_s_table = read.delim(paste(baseD,"pan3can_shared_data/Phospho_databases/PhosphoNetworks/comKSI.csv",sep=""))
}
...
tn = paste(baseD,"pan3can_shared_data/analysis_results/tables/",protein,"_substrate_regression_trans_edited_phosphonetwork.txt", sep="")
