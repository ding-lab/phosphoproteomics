...
# # load data
# BRCA_ProPho = read.table(row.names=1, header=TRUE, sep="\t", file=paste(baseD,"/Users/khuang/Box\ Sync/PhD/proteogenomics/CPTAC_pan3Cancer/pan3can_analysis/cross_correlation/BRCA_RNA_PRO_ks_test.txt",sep=""))
# BRCA_Pho = read.table(row.names=1, header=TRUE, sep="\t", file=paste(baseD,"/Users/khuang/Box\ Sync/PhD/proteogenomics/CPTAC_pan3Cancer/pan3can_analysis/cross_correlation/BRCA_PRO_PHO_ks_test.txt",sep=""))
...
#BRCA_CNV_f = read.table(row.names=1, header=TRUE, sep="\t", file=paste(baseD,"pan3can_shared_data/BRCA/BRCA_CNV_formatted.txt",sep=""))
...
OV_CNV.RNA = calc_corr(OV_PNNL_CNV,OV_PNNL_RNA, name="OV CNV vs. RNA")
# OV_RNA.JHU_Pro = calc_corr(OV_RNA,OV_JHU_Pro, name="OV RNA vs. JHU PRO")
OV_RNA.Pro = calc_corr(OV_PNNL_RNA,OV_PNNL_Pro, name="OV RNA vs. PRO")
OV_Pro.Pho = calc_corr(OV_PNNL_Pro,OV_PNNL_Pho, name="OV PRO vs. PHO")
OV_CNV.Pro = calc_corr(OV_PNNL_CNV,OV_PNNL_Pro, name="OV CNV vs. PRO")
